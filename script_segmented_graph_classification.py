...
from code.MethodSegmentedGraphBertGraphClassification import MethodSegmentedGraphBertGraphClassification
...
if 1:
    for fold in range(1, 11):
        ...
        method_obj = MethodSegmentedGraphBertGraphClassification(bert_config)
        ...
        result_obj.result_destination_folder_path = './result/AuGBert/isolated_segment/'
